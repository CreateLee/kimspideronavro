 ...
 */
package kim.spider.protocol.httpclient;
...
import kim.spider.protocol.ProtocolException;
import kim.spider.protocol.Response;
import kim.spider.protocol.http.HttpBaseSimply;
...
public class HttpSimply extends HttpBaseSimply {
	...
	private void configureClient() {
		...
		//params.setSoTimeout(timeout); 此设置引起抓起点数据相同timeout设置下，跑出timeout异常
