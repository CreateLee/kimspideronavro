...
public class SpellCheckedMetadata extends
		HashMap<java.lang.CharSequence, java.util.List<java.lang.CharSequence>> {
	...
	public void add(final String name, final String value) {
		...
		java.util.List<java.lang.CharSequence> list = super.get(rename);
		if (list == null)
			list = new java.util.ArrayList<java.lang.CharSequence>();
		if (!list.contains(value))
			list.add(value);
		super.put(name, list);
	}

	public java.util.List<java.lang.CharSequence> getValues(final String name) {
		return super.get(getNormalizedName(name));
	}

	public String get(final String name) {
		java.util.List<java.lang.CharSequence> list =  super.get(getNormalizedName(name));
	...
	public void set(final String name, final String value) {
		java.util.List<java.lang.CharSequence> list =  new ArrayList<java.lang.CharSequence>();
		list.add(value);
